      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 rounded-md bg-muted text-xs text-muted-foreground space-y-1">
            ...
            <p>Admin: admin@bazaarly.com / password123</p>
            <p>Seller: seller@bazaarly.com / password123</p>
            <p>Seller: seller2@bazaarly.com / password123</p>
            <p>Customer: customer@bazaarly.com / password123</p>
            <p>Customer: customer2@bazaarly.com / password123</p>
          </div>
        </CardContent>
      </Card>
    </div>
